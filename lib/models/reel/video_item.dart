...
class VideoItem extends Equatable {
  ...
  List<Object?> get props => [
    ...
    likeCount, commentCount, shareCount, isBookmarked, isLiked,
    timestamp, isPremiumContent, duration, mentionedUsers, privacy,
    allowComments, allowSaveToDevice, saveWithWatermark, audienceControlUnder18,
  ];
  ...
  factory VideoItem.fromReelRto(Map<String, dynamic> json) {
    ...
    return VideoItem(
      ...
      allowSaveToDevice:
          json['allowSaveToDevice'] as bool?,
      saveWithWatermark:
          json['saveWithWatermark'] as bool?,
      audienceControlUnder18:
          json['audienceControlUnder18'] as bool?,
    );
  }
