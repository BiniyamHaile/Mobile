...
class _VideoFeedViewState extends State<VideoFeedView>
  ...
  void didChangeDependencies() {
    ...
    context.read<ReelFeedAndActionBloc>().add(LoadInitialVideos());
  }
  ...
  Future<VideoPlayerController?> _getOrCreateController(VideoItem video) async {
    ...
    try {
      ...
      debugPrint(
        'The device does not allow this operation for ${video.videoUrl}...',
      );
      return null;
    }
  }
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          GoRouter.of(
                            context,
                          ).go(RouterEnum.cameraScreen.routeName);
                        },
                        icon: Icon(
                          Icons.videocam,
